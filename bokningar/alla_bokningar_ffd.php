...
$cols = array( "nr" => array("NR", "35px", "table_right"),
  ...
  "grpid" => array("Gruppid", "100px", "table_left"), 
  ...
  "cinvoiceamount" => array("Kundbelopp", "50px", "table_left"), 
  "cffd1" => array("Ffd 1", "50px", "table_left"), 
  "cffd2" => array("Ffd 2", "50px", "table_left"), 
  "totamount" => array("Att betala", "150px", "table_left"), 
  "curr" => array("Valuta", "50px", "table_left"), 
  "ffd1" => array("Ffd 1", "50px", "table_left"), 
  "ffd2" => array("Ffd 2", "50px", "table_left"), 
  "ffd3" => array("Ffd 3", "50px", "table_left"), 
  "info1" => array("Info 1", "50px", "table_left"), 
  "info2" => array("Info 2", "50px", "table_left")
);
?>
...
<h2>Boknings&ouml;versikt med förfallodagar</h2>
<p style="color: #F4F5F4;">Visar samtliga bokningar utom avbokningar</p>

<p><a style="color: #00ac69;padding-right:30px;" href="alla_bokningar_std.php">Visa standardlista</a><a style="color: #00ac69;padding-right:30px;" href="alla_bokningar.php">Visa alla bokningar</a><a style="color: #00ac69;" href="alla_avbokningar.php">Visa avbokningar</a></p>
